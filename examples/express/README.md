# Anvil Vault Express Example

Complete working example of integrating Anvil Vault with Express.js. This example demonstrates how to create a custodial wallet API with automatic key derivation and signing capabilities.
...
You should see wallet addresses for the test user. If successful, the API is working correctly!
...
- **`@anvil-vault/express`** - Express adapter for Anvil Vault
...
- **[@anvil-vault/express](../../packages/express/README.md)** - Express adapter documentation
