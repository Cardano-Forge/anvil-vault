# Anvil Vault Hono Example

Complete working example of integrating Anvil Vault with Hono. This example demonstrates how to create a custodial wallet API with automatic key derivation and signing capabilities using Hono's lightweight framework.
